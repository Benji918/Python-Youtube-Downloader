from flask import Blueprint, redirect, render_template, request, flash, send_file, url_for, session, send_from_directory
...
def subtitle():
    if request.method == 'POST':
        ...
        if subtitleURL:
            ...
            print(file_path)
            return send_file(path_or_file=file_path, as_attachment=True, attachment_filename='subtitle.pdf')
        else:
